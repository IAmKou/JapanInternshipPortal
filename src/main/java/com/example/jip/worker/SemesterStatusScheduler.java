...
public class SemesterStatusScheduler {
    ...
    public void updateSemesterStatus() {
        ...
        System.out.println("Checking for semesters starting or ending on: " + todayDate);

        // Activate semesters that start today
        List<Semester> startingSemesters = semesterRepository.findByStartDate(todayDate);
        System.out.println("Semesters starting today: " + startingSemesters.size());
        ...
        System.out.println("Semesters ending today: " + endingSemesters.size());
